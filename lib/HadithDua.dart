...
class HadithDua {
  ...
  void initializeMap() {
    ...
    hadithObject1 = HadithObject("Entering and Leaving the masjid","مسجد مین داخل حونے کی دعا",
        "اإِذَا دَخَلَ أَحَدُكُمُ الْمَسْجِدَ فَلْيَقُلِ اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ ‏.‏ وَإِذَا خَرَجَ فَلْيَقُلِ اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكََ",
